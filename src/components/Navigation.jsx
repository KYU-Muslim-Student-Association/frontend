...
function ResponsiveAppBar() {
  ...
  return (
     <Box>
      <CssBaseline />
    <AppBar position="static" sx={{bgcolor:"whitesmoke", color:'black'}} elevation>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0, display: { xs: 'flex', md: 'none' , alignItems:'center',justifyContent: "space-between"} }}>
